#!/bin/bash
# docker run --rm -v $PWD/lib-dt-apriltags/:/apriltag -v $PWD/dist/:/dist compiler
# TODO quit if /apriltag doesn't exist

# repository is mounted at /apriltag, build files are under /builds, built shared libraries are stored under /dist
